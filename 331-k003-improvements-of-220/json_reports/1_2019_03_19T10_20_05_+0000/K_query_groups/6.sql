-- queryid: 5607237852481322000
-- NOTICE: the first 50k characters
-- NOTICE: current query size (bytes): '9654'
with fk_indexes as (
 select
...
never_used_indexes as (
 ...
 select
 json_object_agg(nuin.schema_name || $24 || nuin.index_name, nuin) as json
 ...
 *,
 ...
 select
 json_object_agg(ruin.schema_name || $43 || ruin.index_name, ruin) as json
...
redundant_indexes_json as (
 select
 json_object_agg(rin.schema_name || $60 || rin.index_name, rin) as json
