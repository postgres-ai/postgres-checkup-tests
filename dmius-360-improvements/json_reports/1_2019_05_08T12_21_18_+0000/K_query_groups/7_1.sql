-- queryid: 2873432719428424700
-- NOTICE: the first 50k characters
-- NOTICE: current query size (bytes): '5425'
with data as (
 ...
 *,
 ...
 (sum("bloat_size_bytes")::numeric/sum("real_size_bytes")::numeric * $81) as "bloat_ratio_percent_avg",
...
select
 ...
 $84,
 (select count($85) from limited_data where overrided_settings = $86)
 )
