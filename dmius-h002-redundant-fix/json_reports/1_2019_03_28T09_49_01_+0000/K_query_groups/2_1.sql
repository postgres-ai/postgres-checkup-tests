 ...
 *,
 ...
 not i2.indisprimary 
 and not ( 
 (i2.indisprimary or i2.indisunique)
 and (not i1.indisprimary or not i1.indisunique)
 )
 and am1.amname = am2.amname 
 and (
 i1.columns like (i2.columns || $52) 
 or i2.columns = i1.columns 
 )
 and (
 i1.opclasses like (i2.opclasses || $53)
 or i2.opclasses = i1.opclasses
 )
 
 and pg_get_expr(i2.indexprs, i2.indrelid) is not distinct from pg_get_expr(i1.indexprs, i1.indrelid)
 
 and pg_get_expr(i2.indpred, i2.indrelid) is not distinct from pg_get_expr(i1.indpred, i1.indrelid)
